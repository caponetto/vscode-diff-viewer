...
- `Diff Viewer: Show diff line by line`
- `Diff Viewer: Show diff side by side`
- `Diff Viewer: Expand all files`
- `Diff Viewer: Collapse all files`
- `Diff Viewer: Show raw file`
